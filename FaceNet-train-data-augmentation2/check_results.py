...
def check_results(dir_path):
    ...
    plt.subplot(1,2,1)
    plt.plot(x_num,train_loss_list,label="train_loss", color="k")
    ...
    if "test_img_dir" in content.keys():
        plt.plot(x_num, test_acc_list, label="test_acc", color="k")
    plt.legend()
    # plt.ylim((0.9, 0.97))  #limit the range of Y axis
...
if __name__ == "__main__":
    dir_path = r"C:\Users\ztyam\OneDrive - University of Florida\0_UF Class\2021 Spring\03_Pattern Recognition\Project\TrainedModels\FaceNet_masked_pic_aug2_new"
