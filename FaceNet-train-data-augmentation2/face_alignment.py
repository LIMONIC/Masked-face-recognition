...
class FaceMaskDetection():
    def __init__(self,pb_path,margin=44,GPU_ratio=0.1):
        ...
        img_size = (tf_input.shape[2],tf_input.shape[1])
...
if __name__ == "__main__":
    #----alignment
    root_dir = r"C:\Users\ztyam\3D Objects\DataSet\lfw"
    output_dir = r"C:\Users\ztyam\3D Objects\DataSet\lfw-alignment_2"
    margin = 20
    GPU_ratio = None
    img_show = False
    dataset_range = None
