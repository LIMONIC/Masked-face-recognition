...
if __name__ == "__main__":
    train_img_dir = [r"C:\Users\ztyam\3D Objects\DataSet\CASIA-WebFace",]
    ...
    opti_method = "adam"
    learning_rate = 5e-4
    save_dir = r"C:\Users\ztyam\OneDrive - University of Florida\0_UF Class\2021 Spring\03_Pattern Recognition\Project\test"
    ...
    batch_size = 96#depends on your GPU resource. Set <= 96 if 6GB GPU
    ratio = 0.002#0.002
