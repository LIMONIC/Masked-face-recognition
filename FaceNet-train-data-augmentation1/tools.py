...
def random_img_select(root_dir,output_dir,select_num=1):
    #----var
...
def get_embeddings(sess,paths,tf_dict,batch_size=128):
    ...
    # model_shape = [None,160,160,3]
    feed_dict = {tf_phase_train: False,tf_keep_prob:1.0}
    # feed_dict = {tf_phase_train: False}
    # feed_dict = {}
...
if __name__ == "__main__":
    ...
    #----random_img_select
    # root_dir = r"D:\dataset\CASIA\CASIA_face_detect_aligned(clean)"
    # output_dir = r"D:\dataset\CASIA\test_database"
    # select_num = 3
    #
    # random_img_select(root_dir, output_dir, select_num=select_num)

    #----face matching evaluation
    root_dir = r"D:\dataset\CASIA\CASIA_face_detect_aligned_mask(fromClean)"
    face_databse_dir = r"D:\dataset\CASIA\test_database"
    # pb_path = r"D:\code\model_saver\FaceNet_tutorial\test_2\pb_model.pb"
    pb_path = r"D:\code\model_saver\facenet_by_J\Embed128_inception_resnet_V1_cross_entropy_face_all\pb_model.pb"
